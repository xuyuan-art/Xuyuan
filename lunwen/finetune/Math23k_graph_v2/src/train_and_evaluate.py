...
def train_tree(input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, generate_nums,
               ...
               merge_optimizer, output_lang, num_pos, bert_input, batch_graph=None, english=False):
    ...
    bert_input = collate_bert_encodings(bert_input)
...
def evaluate_tree(input_batch, input_length, generate_nums, encoder, predict, generate, merge, output_lang, num_pos,
                  bert_input, batch_graph=None, beam_size=5, english=False, max_length=MAX_OUTPUT_LENGTH):
    ...
    encoder_outputs, problem_output = encoder.evaluate(
        input_var, [input_length], bert_input, batch_graph=batch_graph, num_pos=[num_pos]
    )
